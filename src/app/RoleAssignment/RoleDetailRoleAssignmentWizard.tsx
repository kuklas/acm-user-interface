  ...
  const handleNext = () => {
    if (currentStep === 1) {
      ...
      if (resourceScope === 'everything') {
        ...
        } else if (showClusterSelection && selectedClusters.length > 0 && !showScopeSelection) {
  ...
  const handleBack = () => {
    if (currentStep === 1) {
      ...
      if (showProjectSelection) {
        ...
        // Go back from scope selection to cluster/cluster set selection
        setShowScopeSelection(false);
        setClusterScope('everything');
        setSelectedProjects([]);
              ...
              >
                ...
                {resourceScope === 'cluster-sets' && !showClusterSetSelection && (
                  <ExpandableSection
                    ...
                    onToggle={(_event, isExpanded) => setIsClusterSetExampleExpanded(isExpanded)}
                  >
              <div style={{ 
                    padding: '16px', 
                backgroundColor: '#f5f5f5', 
                ...
                {resourceScope === 'clusters' && !showClusterSelection && (
                  <ExpandableSection
                    toggleText="View example scope"
                    isExpanded={isClusterExampleExpanded}
                    onToggle={(_event, isExpanded) => setIsClusterExampleExpanded(isExpanded)}
                  >
                      <div style={{ 
                    padding: '16px', 
                    backgroundColor: '#f5f5f5', 
                ...
                {resourceScope === 'everything' && (
                  <>
                    ...
                    <ExpandableSection
                      toggleText="View example scope"
                      isExpanded={isEverythingExampleExpanded}
                      onToggle={(_event, isExpanded) => setIsEverythingExampleExpanded(isExpanded)}
                    >
                      <div style={{ 
                      padding: '16px', 
                      backgroundColor: '#f5f5f5', 
